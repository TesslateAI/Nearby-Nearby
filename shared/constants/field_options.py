...
# Each item: { "group": str, "label": str }
# Groups: Space + Size / Grab Bars / Door / Toilet / Sink + Fixtures / General
...
# Flat label list derived from RESTROOM_ADA_CHECKLIST for backend validation
RESTROOM_ADA_CHECKLIST_LABELS = [item["label"] for item in RESTROOM_ADA_CHECKLIST]
