    ...
    <>
      <header className="page_header_style_1">
        <div className="wrapper_default">
          <h1 className="page_title">Suggest an Event</h1>
          <p className="page_excerpt">
            Know about a local event happening in your community? Let us know and we&rsquo;ll add it to Nearby Nearby so others can discover it too.
          </p>
        </div>
      </header>
