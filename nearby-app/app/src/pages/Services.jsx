    ...
    <>
      <header className="page_header_style_1">
        <div className="wrapper_default">
          <h1 className="page_title">Nearby Nearby Services</h1>
          <p className="page_excerpt">
            Helping people discover, connect with, and support rural communities through local discovery, business visibility, and community technology.
          </p>
        </div>
      </header>
      ...
      <div className="main_content_padding">
        <div className="wrapper_default">
          ...
          <h2 className="title_style_3">Local Discovery and Travel Information Tools</h2>
          <p>
          ...
          <h2 className="title_style_3">Business Visibility and Marketplace Services</h2>
          <p>
          ...
          <h2 className="title_style_3">Cultural and Educational Content</h2>
          <p>
          ...
          <p>
            These services are provided through our website, digital channels, and community partnerships. Nearby Nearby advances local knowledge, community visibility, and visitor readiness through accessible content and shared learning across rural communities.
          </p>

          <h2 className="title_style_3">Technology and Data Services for Community, Tourism, and Resilience Support</h2>
          <p>
          ...
          <p>
            To inquire about partnership, licensing, or access to our API and technology services, contact <a href="mailto:connect@nearbynearby.com">connect@nearbynearby.com</a>.
          </p>

          <h2 className="title_style_3">Data Services and Local Insights</h2>
          <p>
          ...
          <p>
            These data services are available through custom reports, dashboards, or partner API integrations and are designed to support stronger rural economies, targeted tourism growth, and informed community investment. All insights will be anonymized and focused on supporting stronger rural economies and better decision making.
          </p>

          <h2 className="title_style_3">Downloadable Mobile Access</h2>
          <p>
          ...
          <p>This keeps Nearby Nearby close at hand whenever people are out in their community.</p>
          <p><InstallButton /></p>
