...
import { MapPin, Clock, Phone, Globe, Share2, Navigation, Copy, Check, ExternalLink } from 'lucide-react';
        ...
        <div className="poi-detail__container">
          ...
          <div className="poi-detail__collapsible-sections">
            <Accordion closeOther closeAble scrollOffset={120}>
              <AccordionSection title="ABOUT + HOURS" show={hasContent(poi.description_long) || hasContent(poi.hours)}>
              ...
              <AccordionSection title="ADDRESS + PARKING" show={hasContent(poi.address_street) || hasContent(poi.parking_types) || hasContent(poi.parking_notes) || hasContent(poi.public_transit_info)}>
                <div className="collapsible-section__info">
              ...
              {poi.poi_type === "BUSINESS" && (
                <AccordionSection title="MENU + ORDERING" show={hasContent(poi.business?.price_range) || hasContent(poi.alcohol_options) || hasContent(poi.price_range_per_person)}>
                  <div className="collapsible-section__info">
              ...
              <AccordionSection title="WHAT TO EXPECT" show={hasContent(poi.wheelchair_accessible) || hasContent(poi.wifi_options) || hasContent(poi.payment_methods) || hasContent(poi.ideal_for) || hasContent(poi.amenities) || hasContent(poi.key_facilities)}>
                <div className="collapsible-section__info">
              ...
              <AccordionSection title="PUBLIC RESTROOMS" show={hasContent(poi.public_toilets) || hasContent(poi.toilet_description)}>
                <div className="collapsible-section__info">
              ...
              <AccordionSection title="ACCESSIBILITY" show={hasContent(poi.wheelchair_accessible) || hasContent(poi.wheelchair_details)}>
                <div className="collapsible-section__info">
              ...
              <AccordionSection title="PET POLICY" show={hasContent(poi.pet_options) || hasContent(poi.pet_policy)}>
                <div className="collapsible-section__info">
              ...
              {poi.poi_type === "PARK" && (
                <AccordionSection title="PLAYGROUND" show={poi.playground_available === true || hasContent(poi.playground_types) || hasContent(poi.playground_notes)}>
                  <div className="collapsible-section__info">
              ...
              {poi.poi_type === "EVENT" && poi.event && (
                <AccordionSection title="EVENTS" show={hasContent(poi.event.start_datetime) || hasContent(poi.event.end_datetime) || hasContent(poi.event.organizer_name)}>
                  <div className="collapsible-section__info">
              ...
              {poi.poi_type === "TRAIL" && poi.trail && (
                <AccordionSection title="TRAIL DETAILS" show={hasContent(poi.trail.length_text) || hasContent(poi.trail.difficulty) || hasContent(poi.trail.route_type) || hasContent(poi.trail.difficulty_description)}>
                  <div className="collapsible-section__info">
              ...
              <AccordionSection title="RENTALS" show={poi.available_for_rent === true || hasContent(poi.rental_info) || hasContent(poi.rental_pricing)}>
                <div className="collapsible-section__info">
              ...
              <AccordionSection title="LOCALLY FOUND" show={hasContent(poi.locally_found_at)}>
                <div className="collapsible-section__info">
                  <InfoRow label="Available At" value={poi.locally_found_at} />
                </div>
              </AccordionSection>

              <AccordionSection title="PROVIDES SERVICES TO" show={hasContent(poi.service_locations)}>
                <div className="collapsible-section__info">
                  <InfoRow label="Locations" value={poi.service_locations} />
                </div>
              </AccordionSection>

              <AccordionSection title="HISTORY + COMMUNITY" show={hasContent(poi.community_impact) || hasContent(poi.history_paragraph)}>
                <div className="collapsible-section__info">
              ...
              <AccordionSection title="ALCOHOL + SMOKING" show={hasContent(poi.smoking_options) || hasContent(poi.smoking_details) || hasContent(poi.alcohol_options) || hasContent(poi.alcohol_description)}>
              ...
              <AccordionSection title="DRONE POLICY" show={hasContent(poi.drone_usage) || hasContent(poi.drone_policy)}>
                <div className="collapsible-section__info">
              ...
              <AccordionSection title="PRICING + TICKETS" show={hasContent(poi.cost) || hasContent(poi.pricing_details) || hasContent(poi.ticket_link)}>
                <div className="collapsible-section__info">
              ...
              <AccordionSection title="CONTACT + SOCIAL MEDIA" show={hasContent(poi.phone_number) || hasContent(poi.email) || hasContent(poi.website_url) || hasContent(poi.instagram_username) || hasContent(poi.facebook_username)}>
                <div className="collapsible-section__info">
